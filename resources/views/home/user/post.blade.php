...
@section('main')
    ...
    <div class="post" data-id="{{ $post->uid }}">
        ...
        <div class="post-about">
            ...
            <a class="forum" href="{{ url('home?type=posts&forum='.$forum->brief) }}">{{ $forum->title }}</a>
        </div>
        ...
        <ul class="nav nav-pills">
            <li><a href="{{ url('home?type=reply&uid='.$post->uid) }}">原文评论 <span class="badge">{{ $post->replies }}</span></a></li>
        </ul>
